...
export function Modal({ open, onClose, children }: { open: boolean; onClose: () => void; children: ReactNode }) {
  ...
  const useDashboardMotion = document.body.classList.contains("theme-dark");
  ...
  return createPortal(
    <div
      className={cn(
        ...
        visible
          ? useDashboardMotion ? "bg-black/65 backdrop-blur-[5px]" : "opacity-100"
          : useDashboardMotion ? "bg-black/0 backdrop-blur-none" : "opacity-0"
      )}
      onClick={onClose}
      role="presentation"
    >
      <div
        ...
        className={cn(
          ...
          visible
            ...
            : useDashboardMotion ? "translate-y-5 scale-[0.955] opacity-0" : "translate-y-2 scale-[0.97] opacity-0"
        )}
        role="dialog"
        aria-modal="true"
      >
