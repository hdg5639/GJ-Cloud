...
import type { VmAvailabilityResponse, SshKeyResponse, ProfileResponse } from "@/lib/types";
...
export default function CreateInstancePage() {
  ...
  const proDisabled = proFull || (userPlan === "FREE");  // FREE plan이면 PRO 비활성화
            ...
            {(["FREE", "PRO"] as const).map((plan) => {
              ...
              return (
                ...
                >
                  ...
                  {planLocked && (
                    <span className="absolute -top-2.5 right-3 z-10 bg-gray-100 text-gray-600 text-[11px] font-medium px-2 py-0.5 rounded-md">
                      업그레이드 필요
                    </span>
                  )}
